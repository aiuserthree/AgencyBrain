        ...
        if (undefinedOptions.length > 0) {
            ...
            const getOptionInfo = (opt) => {
                ...
                const keywordMappings = [
                    ...
                    // === API/연동 ===
                    { keywords: ['api 키', 'api키'], desc: 'API 키 발급 및 관리', ui: '[폼] API 키', action: '키발급 → 복사 → 테스트 → 관리' },
                    { keywords: ['api 연동', 'api연동'], desc: '외부 API 연동 설정', ui: '[설정] API 연동', action: 'API선택 → 인증설정 → 테스트 → 저장' },
                    { keywords: ['웹훅', 'webhook'], desc: '이벤트 웹훅 설정', ui: '[폼] 웹훅 설정', action: 'URL입력 → 이벤트선택 → 저장 → 테스트' },
                    { keywords: ['연동 설정', '연동설정'], desc: '외부 서비스 연동 관리', ui: '[리스트] 연동 관리', action: '서비스선택 → 인증 → 연동 → 동기화' },
                    { keywords: ['사용량', '사용량 조회'], desc: 'API/서비스 사용량 조회', ui: '[차트] 사용량', action: '기간선택 → 사용량조회 → 한도확인' },
                    
                    // === 기타 공통 ===
                    { keywords: ['저장'], desc: '데이터 저장 처리', ui: '[버튼] 저장', action: '저장클릭 → 유효성검사 → 저장 → 완료알림' },
                    { keywords: ['삭제'], desc: '데이터 삭제 처리', ui: '[버튼] 삭제', action: '삭제클릭 → 확인모달 → 삭제 → 완료' },
                    { keywords: ['수정', '편집'], desc: '데이터 수정/편집', ui: '[폼] 수정', action: '편집모드 → 수정 → 저장 → 완료' },
                    { keywords: ['취소'], desc: '작업 취소 처리', ui: '[버튼] 취소', action: '취소클릭 → 확인 → 취소처리 → 이전상태' },
                    { keywords: ['확인', '확정'], desc: '작업 확인/확정 처리', ui: '[버튼] 확인', action: '확인클릭 → 처리 → 완료' },
                    { keywords: ['완료'], desc: '작업 완료 처리', ui: '[버튼] 완료', action: '완료클릭 → 상태변경 → 알림' },
                    { keywords: ['이력', '히스토리'], desc: '이력/히스토리 조회', ui: '[타임라인] 이력', action: '기간선택 → 이력조회 → 상세' },
                    { keywords: ['다운로드'], desc: '파일 다운로드', ui: '[버튼] 다운로드', action: '다운로드클릭 → 파일생성 → 다운로드' },
                    { keywords: ['업로드'], desc: '파일 업로드', ui: '[업로더] 파일 업로드', action: '파일선택 → 업로드 → 완료' },
                    { keywords: ['미리보기', '프리뷰'], desc: '콘텐츠/파일 미리보기', ui: '[모달] 미리보기', action: '미리보기클릭 → 표시 → 확인' },
                    { keywords: ['공유'], desc: 'SNS/링크 공유', ui: '[버튼그룹] 공유', action: '공유클릭 → 채널선택 → 공유실행' },
                    { keywords: ['복사'], desc: '링크/텍스트 복사', ui: '[버튼] 복사', action: '복사클릭 → 클립보드저장 → 완료알림' },
                    { keywords: ['인쇄', '프린트'], desc: '문서/내용 인쇄', ui: '[버튼] 인쇄', action: '인쇄클릭 → 미리보기 → 인쇄' },
                    { keywords: ['선택'], desc: '항목 선택', ui: '[체크박스/라디오] 선택', action: '항목클릭 → 선택 → 적용' },
                    { keywords: ['입력'], desc: '데이터 입력', ui: '[입력필드] 입력', action: '필드클릭 → 입력 → 유효성검사' },
                    { keywords: ['조회'], desc: '데이터 조회', ui: '[버튼] 조회', action: '조건입력 → 조회 → 결과표시' },
                    { keywords: ['발급'], desc: '증명서/문서 발급', ui: '[버튼] 발급', action: '발급신청 → 생성 → 다운로드' },
                    { keywords: ['신청'], desc: '서비스/기능 신청', ui: '[폼] 신청', action: '정보입력 → 신청 → 접수 → 처리' },
                    { keywords: ['접수'], desc: '요청 접수 처리', ui: '[폼] 접수', action: '정보확인 → 접수 → 처리대기' },
                    { keywords: ['승인'], desc: '요청 승인 처리', ui: '[버튼] 승인', action: '내용확인 → 승인 → 알림발송' },
                    { keywords: ['반려'], desc: '요청 반려 처리', ui: '[버튼] 반려', action: '사유입력 → 반려 → 알림발송' },
                    { keywords: ['종료'], desc: '서비스/세션 종료', ui: '[버튼] 종료', action: '종료클릭 → 확인 → 종료처리' },
                    { keywords: ['시작'], desc: '서비스/기능 시작', ui: '[버튼] 시작', action: '시작클릭 → 초기화 → 실행' },
                    { keywords: ['재시도'], desc: '실패 작업 재시도', ui: '[버튼] 재시도', action: '재시도클릭 → 재실행 → 결과확인' },
                    { keywords: ['초기화'], desc: '설정/데이터 초기화', ui: '[버튼] 초기화', action: '초기화클릭 → 확인 → 초기화 → 완료' },
                    { keywords: ['새로고침', '갱신'], desc: '데이터 새로고침', ui: '[버튼] 새로고침', action: '새로고침클릭 → 데이터조회 → 갱신' },
                    { keywords: ['추가'], desc: '항목 추가', ui: '[버튼] 추가', action: '추가클릭 → 정보입력 → 저장' },
                    { keywords: ['제거'], desc: '항목 제거', ui: '[버튼] 제거', action: '제거클릭 → 확인 → 제거' }
                ];
